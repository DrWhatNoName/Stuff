<?php //this page is used to authenticate the user and it's login info, it will set the cookies
	...
	$verify = security::smartslashes($_POST['passvfy']);
	...
	if($_POST['vfy'] == "doverify" && $pass != $verify)
	{
		Header( 'Location: index.php?vfyfail=true' );
	}
	elseif(PB::Login($user, $pass, $keyfile, (int)$_POST['time'], $token, $key)) //check if login success
	{
